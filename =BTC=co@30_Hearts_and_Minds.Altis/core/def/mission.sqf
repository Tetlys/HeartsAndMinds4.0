...
if (isServer) then {
    ...
    //Database
    btc_db_load = _p_db;
    btc_db_serverCommandPassword = "goaskryan";
    ...
    btc_cache_type = [
        _allClassSorted select {
            _x isKindOf "CUP_hromada_beden_dekorativniX" 
           // && {getText(_cfgVehicles >> _x >> "model") isEqualTo "\A3\weapons_F\AmmoBoxes\AmmoBox_F"}
        },
        ["HazmatBag_01_F", "Land_PlasticCase_01_small_CBRN_F"]
    ];
    ...
    //Side
    btc_side_ID = 0;
    btc_side_list = ["supply", "mines", "vehicle", "get_city", "tower", "civtreatment", "checkpoint", "convoy", "rescue", "capture_officer", "hostage", "hack", "kill", "removeRubbish"]; // On ground (Side "convoy" and "capture_officer" are not design for map with different islands. Start and end city can be on different islands.)
    ...
    btc_vehicles = [btc_veh_1, btc_veh_2, btc_veh_3, btc_veh_4, btc_veh_5, btc_veh_6, btc_veh_7, btc_veh_8, btc_veh_9, btc_veh_10, btc_veh_11, btc_veh_12, btc_veh_13, btc_veh_14, btc_veh_15, btc_veh_16, btc_veh_17, btc_veh_18, btc_veh_19, btc_veh_20, btc_veh_21, btc_veh_22, btc_veh_23, btc_veh_24, btc_veh_25, btc_veh_26, btc_veh_27, btc_veh_28, btc_veh_29, btc_veh_30, btc_veh_31, btc_veh_32, btc_veh_33, btc_veh_34, btc_veh_35, btc_veh_36, btc_veh_37, btc_veh_38, btc_veh_39];
    btc_helo = [btc_helo_1, btc_helo_2];
...
if (isServer) then {
    ...
    [
        ...
        {_x isKindOf "RHS_MK19_TriPod_D"}) && {
            getNumber (_cfgVehicles >> _x >> "side") isEqualTo ([west] find btc_player_side)
        }
    });
...
btc_log_def_rc = [
    btc_supplies_cargo, 9999,
    "Land_Medevac_house_V1_F", 20,
    btc_fob_mat, 9999,
    "B_Slingload_01_Cargo_F", 9999,
...
btc_log_fnc_get_nottowable = {
    ...
    switch (true) do {
        ...
        case (_tower isKindOf "Truck_F") : {["Ship"];};
        case (_tower isKindOf "Truck") : {["Ship"];};
