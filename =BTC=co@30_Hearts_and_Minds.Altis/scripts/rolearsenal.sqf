...
roleArsenal = {
	...
	or (_UnitRole == "Assassin 1-3 Squad Leader@Assassin 2-1 (Infantry)")
	or (_UnitRole == "Assassin 1-3 Squad Leader@Assassin 2-2 (Infantry)")
	or (_UnitRole == "Assassin 1-3 Squad Leader@Assassin 2-3 (Infantry)")
	or (_UnitRole == "Assassin 1-3 Squad Leader@Assassin 2-4 (Infantry)")) then
	{_Role = "SQDCO"};
